...
def test_ips_check():
    ...
    hist = [{"date": "2026-06-24", "总净资产": "1000000", "金融资产": "800000", "权益": "300000", "黄金": "40000"},
            {"date": "2026-07-01", "总净资产": "1000000", "金融资产": "800000", "权益": "420000", "黄金": "10000"}]
    tgt = {"权益": 0.34, "黄金": 0.04}
    ledger = [
        ...
        {"日期": "2026-07-02", "动作": "买入", "名称": "甲", "资产类型": "A股权益ETF",
         "成交额": "80000", "原因/备注": "再平衡"},                  # R2 买超配(42%>39%)违纪 + R3 大额(10%>金融资产5%)
