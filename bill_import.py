...
CATEGORIES = [
    ("餐饮·外食", ["餐饮", "烧烤", "湘菜", "面包", "咖啡", "甜品", "肯德基", "KFC", "麦当劳",
                 ...
                 "宝庆荟", "小馆", "食堂", "火锅", "烤肉", "奶茶", "酒馆", "饭店", "烤鸭",
                 "民福", "野风筝", "咖啡", "茶姬", "茶饮", "便利", "麦当劳", "汉堡", "牛排"]),
    ("餐饮·食材", ["超市", "七鲜", "广缘", "幸福", "菜市", "生鲜", "盒马", "永辉", "小象"]),
...
DEFAULT_RIGIDITY = {
    ...
    "娱乐·游戏": "弹性", "娱乐·出游": "弹性", "日用百货": "刚性", "个护·美容": "弹性",
